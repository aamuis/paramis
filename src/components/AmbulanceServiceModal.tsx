...
export const AmbulanceServiceModal: React.FC<AmbulanceServiceModalProps> = ({
  ...
  const handleWhatsAppDispatch = () => {
    const text = encodeURIComponent(
      'Assalamu’alaikum Admin PARAMIS FOUNDATION, saya ingin memohon bantuan/konfirmasi Layanan Ambulans Siaga 24 Jam untuk warga/pasien darurat...'
    );
  ...
  return (
    ...
    >
      ...
      >
        {/* Header with Emergency Red/Blue Accent */}
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-[10px] text-blue-200">Bogor & Sekitarnya</span>
              </div>
              <h3 className="text-base font-bold leading-tight mt-0.5">
                Layanan Ambulans PARAMIS
              </h3>
            </div>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4 text-xs">
          {/* Free for Dhuafa Guarantee Banner */}
          <div className="p-3.5 rounded-2xl bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-800/60 text-emerald-900 dark:text-emerald-200 flex items-start gap-2.5">
            ...
            <div className="space-y-1">
              <p className="font-bold text-[12px]">
                100% Bebas Biaya bagi Kaum Dhuafa & Pasien Pra-Sejahtera
              </p>
              <p className="text-[11px] text-emerald-800 dark:text-emerald-300/90 leading-relaxed">
                Yayasan PARAMIS FOUNDATION mendedikasikan armada ambulans untuk melayani rujukan gawat darurat, pasien cuci darah/kemoterapi dhuafa, dan mobil jenazah.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2 text-[11px]">
              <div className="p-2.5 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/60">
                <span className="font-bold text-slate-900 dark:text-white block">🚑 Tabung Oksigen Medis</span>
                <span className="text-[10px] text-slate-500">Regulator & selang standar medis</span>
              </div>
              <div className="p-2.5 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/60">
                <span className="font-bold text-slate-900 dark:text-white block">🛏️ Keranda & Stretcher</span>
                <span className="text-[10px] text-slate-500">Layanan pasien & mobil jenazah</span>
              </div>
              <div className="p-2.5 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/60">
                <span className="font-bold text-slate-900 dark:text-white block">👨‍✈️ Driver & Paramedis Siaga</span>
                <span className="text-[10px] text-slate-500">Tim relawan terlatih 24/7</span>
              </div>
              <div className="p-2.5 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/60">
                <span className="font-bold text-slate-900 dark:text-white block">📍 Posko Induk Bogor Barat</span>
                <span className="text-[10px] text-slate-500">Cilendek Barat & Jabodetabek</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-2 pt-1">
            ...
            <div className="flex flex-col gap-2">
              ...
              >
                ...
                <span>Pesan Ambulans via WhatsApp (0851-9555-5674)</span>
              </button>
              ...
              >
                ...
                <span>Panggilan Telepon Darurat</span>
              </button>
            </div>
          </div>

          {/* Support Ambulance Operation via Donation */}
          <div className="p-3 rounded-2xl bg-blue-50 dark:bg-blue-950/40 border border-blue-200/80 dark:border-blue-900/50 flex items-center justify-between gap-2">
            <div className="space-y-0.5">
              <span className="font-bold text-slate-900 dark:text-white text-[11px] block">
                Bantu BBM & Perawatan Armada
              </span>
              <span className="text-[10px] text-slate-500 dark:text-slate-400 block">
                Sedekah operasional agar ambulans terus gratis untuk dhuafa
              </span>
            </div>
        ...
        <div className="p-3 border-t border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 text-center">
          <p className="text-[10px] text-slate-500 dark:text-slate-400">
            Posko: Jl. Dr. Sumeru Gg. Nasedin No.3, Cilendek Barat, Bogor Barat
          </p>
        </div>
      </div>
    </div>
